...
class Tooltip extends React.Component {
  constructor() {
    ...
    this.renderPointer = tooltipY => {
      const {yOffset, xOffset, elementHeight, elementWidth} = this.state;
      const {backgroundColor, pointerColor, trianglePosition, triangleOffset} =
        this.props;
      ...
      if (trianglePosition === 'middle')
        ...
        left =
          xOffset +
          getElementVisibleWidth(elementWidth, xOffset, ScreenWidth) -
          triangleOffset;
      }
      return (
        <View
          style={{
            ...
            [I18nManager.isRTL ? 'right' : 'left']: left ? left : 0,
          }}>
          <Triangle
            style={{
