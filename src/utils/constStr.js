export const constVar = {
  ...
  askForPostsFavorites:
    'Η δημιουργία του ride πραγματοποιήθηκε επιτυχώς. Μπορείς να το αποθηκεύσεις στα αγαπημένα έτσι ώστε να μην συμπληρώσεις ξανά τις πληροφορίες.',
  go: 'Πάμε',
  ...
  createPostBottomTab: 'Δημιουργία ride',
  selectCarAge: 'Επιλογή χρονολογίας',
